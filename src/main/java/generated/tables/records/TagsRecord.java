...
public class TagsRecord extends UpdatableRecordImpl<TagsRecord> implements Record3<Integer, Integer, String> {
	...
	private static final long serialVersionUID = -1929157745;
	...
	/**
	 * Setter for <code>public.tags.receip_id</code>.
	 */
	public void setReceipId(Integer value) {
		setValue(1, value);
	}

	/**
	 * Getter for <code>public.tags.receip_id</code>.
	 */
	 ...
	 */
	public TagsRecord(Integer tid, Integer receipId, String tag) {
		super(Tags.TAGS);
